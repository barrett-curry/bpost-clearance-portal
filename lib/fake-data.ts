...
export type Shipment = {
  ...
  dutyTax?: number;
  dutyTerms: "collected_at_checkout" | "collect_upon_delivery" | "collected_by_royal_mail";
...
export const demoCompany = {
  ...
  email: "j.mitchell@rosieandjack.co.uk",
  address: "85 Kensington High Street",
  city: "London",
  postcode: "W8 5SE",
  country: "United Kingdom",
  countryCode: "GB",
  rmAccount: "6045-2891-3",
  eori: "GB987654321000",
  ein: "98-7654321",
...
export const products: Product[] = [
  ...
  },
  {
    ...
    confidence: 78,
    description: "Children's rubber wellington boots, pull-on handles, sizes UK 4-2",
...
export const shipments: Shipment[] = [
  {
    ...
    timeline: [
      { date: "2026-02-20", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-20", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-21", status: "In Transit", detail: "Departed London Stansted" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-18", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-18", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-19", status: "In Transit", detail: "Departed London Heathrow" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-15", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-15", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-16", status: "In Transit", detail: "Departed London Gatwick" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-24", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-24", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-25", status: "In Transit", detail: "Departed London Heathrow", active: true },
    ],
  },
  {
    id: "ship-005",
    ...
    timeline: [
      { date: "2026-02-22", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-22", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-23", status: "In Transit", detail: "Departed London Stansted" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-25", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-25", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-26", status: "In Transit", detail: "Departed London Heathrow", active: true },
    ],
  },
  {
    id: "ship-007",
    ...
    dutyTerms: "collected_by_royal_mail",
    dutyTax: 54.00,
    dutyCollected: 54.00,
    flags: ["Docs Missing"],
    shipDate: "2026-02-21",
    estimatedDelivery: "2026-03-01",
    timeline: [
      { date: "2026-02-21", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-21", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-22", status: "In Transit", detail: "Departed London Heathrow" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-19", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-19", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-20", status: "In Transit", detail: "Departed London St Pancras" },
  ...
  },
  {
    ...
    estimatedDelivery: "2026-02-28",
    timeline: [
      { date: "2026-02-23", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-23", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-24", status: "In Transit", detail: "Departed London Stansted" },
  ...
  },
  {
    ...
    estimatedDelivery: "2026-02-28",
    timeline: [
      { date: "2026-02-26", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-26", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-27", status: "In Transit", detail: "Departed London St Pancras", active: true },
    ],
  },
  {
    id: "ship-011",
    ...
    timeline: [
      { date: "2026-02-22", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-22", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-23", status: "In Transit", detail: "Departed London Heathrow" },
  ...
  },
  {
    ...
    estimatedDelivery: "2026-02-24",
    timeline: [
      { date: "2026-02-17", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-17", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-18", status: "In Transit", detail: "Departed London Heathrow" },
  ...
  },
  {
    ...
    timeline: [
      { date: "2026-02-19", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-19", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-20", status: "In Transit", detail: "Departed London Heathrow" },
  ...
  },
  {
    ...
    estimatedDelivery: "2026-03-02",
    timeline: [
      { date: "2026-02-27", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-27", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-28", status: "In Transit", detail: "Departed London Stansted", active: true },
    ],
  },
  {
    id: "ship-015",
    ...
    timeline: [
      { date: "2026-02-20", status: "Label Created", detail: "Shipping label created in London" },
      { date: "2026-02-20", status: "Picked Up", detail: "Package picked up by bpost" },
      { date: "2026-02-21", status: "In Transit", detail: "Departed London Heathrow" },
...
export const alerts: Alert[] = [
  ...
  },
  {
    ...
    description: "Adding your UK VAT registration number and completing broker authorization could reduce your average clearance time by up to 40%.",
...
export const documents: DocItem[] = [
  ...
  {
    id: "doc-003",
    name: "UK Export License - Textiles",
    type: "Export License",
    status: "verified",
