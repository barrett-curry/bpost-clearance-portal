...
const reconciliationRecords = [
  { id: "REC-001", customer: "Rosie & Jack Kidswear", accountId: "BP-ACCT-4521", quoteId: "QT-2024-4521", orderId: "ORD-2024-3891", shipmentId: "BP-2024-00847", customsEntry: "CE-UK-2024-12847", rmCharged: "€162.00", collected: "€162.00", variance: "€0.00", variancePct: "0%", status: "matched", stage: "settled" },
  { id: "REC-002", customer: "Northfield Electronics Ltd", accountId: "BP-ACCT-4522", quoteId: "QT-2024-4522", orderId: "ORD-2024-3892", shipmentId: "BP-2024-00848", customsEntry: "CE-UK-2024-12848", rmCharged: "€100.80", collected: "€126.00", variance: "+€25.20", variancePct: "+25%", status: "variance", stage: "under-review" },
  { id: "REC-003", customer: "Celtic Crafts Distribution", accountId: "BP-ACCT-4523", quoteId: "QT-2024-4523", orderId: "ORD-2024-3893", shipmentId: "BP-2024-00849", customsEntry: "CE-UK-2024-12849", rmCharged: "€106.40", collected: "€106.40", variance: "€0.00", variancePct: "0%", status: "matched", stage: "settled" },
  { id: "REC-004", customer: "Rosie & Jack Kidswear", accountId: "BP-ACCT-4521", quoteId: "QT-2024-4524", orderId: "ORD-2024-3894", shipmentId: "BP-2024-00850", customsEntry: "-", rmCharged: "€34.20", collected: "-", variance: "-", variancePct: "-", status: "in-transit", stage: "customs-submitted" },
  { id: "REC-005", customer: "Brighton Botanicals Ltd", accountId: "BP-ACCT-4525", quoteId: "QT-2024-4525", orderId: "ORD-2024-3895", shipmentId: "BP-2024-00851", customsEntry: "CE-UK-2024-12851", rmCharged: "€180.00", collected: "€187.50", variance: "+€7.50", variancePct: "+4.2%", status: "variance", stage: "under-review" },
  { id: "REC-006", customer: "Northfield Electronics Ltd", accountId: "BP-ACCT-4522", quoteId: "QT-2024-4526", orderId: "ORD-2024-3896", shipmentId: "BP-2024-00852", customsEntry: "CE-UK-2024-12852", rmCharged: "€84.00", collected: "€84.00", variance: "€0.00", variancePct: "0%", status: "matched", stage: "settled" },
  { id: "REC-007", customer: "Highland Spirits Co", accountId: "BP-ACCT-4527", quoteId: "QT-2024-4527", orderId: "ORD-2024-3897", shipmentId: "BP-2024-00853", customsEntry: "CE-UK-2024-12853", rmCharged: "€245.00", collected: "€245.00", variance: "€0.00", variancePct: "0%", status: "matched", stage: "settled" },
  { id: "REC-008", customer: "Celtic Crafts Distribution", accountId: "BP-ACCT-4523", quoteId: "QT-2024-4528", orderId: "ORD-2024-3898", shipmentId: "BP-2024-00854", customsEntry: "CE-UK-2024-12854", rmCharged: "€56.80", collected: "€62.10", variance: "+€5.30", variancePct: "+9.3%", status: "variance", stage: "under-review" },
];
...
const chargeBreakdown = {
  ...
  items: [
    { description: "Artisan Cheese Selection (3kg)", hsCode: "0406.90", coo: "FR", declaredValue: "€120.00", rmChargedDuty: "€14.40", hmrcActualDuty: "€18.00", rmChargedVAT: "€26.88", hmrcActualVAT: "€33.60" },
    { description: "Charcuterie Board Set", hsCode: "4419.12", coo: "IT", declaredValue: "€85.00", rmChargedDuty: "€0.00", hmrcActualDuty: "€0.00", rmChargedVAT: "€17.00", hmrcActualVAT: "€17.00" },
    { description: "Truffle Oil (250ml x2)", hsCode: "1515.90", coo: "FR", declaredValue: "€45.00", rmChargedDuty: "€3.74", hmrcActualDuty: "€6.00", rmChargedVAT: "€9.75", hmrcActualVAT: "€11.40" },
  ],
...
const auditTrail = [
  ...
  { timestamp: "2024-03-13 09:15:01", event: "Variance Detected", reference: "REC-002", detail: "Duty variance +€25.20 on RM-2024-00848 - customer Northfield Electronics under-charged", user: "System (Recon Engine)" },
  { timestamp: "2024-03-13 09:15:00", event: "HMRC Settlement", reference: "CE-UK-2024-12848", detail: "HS reclassified to 0406.40 by HMRC - duty rate changed from 12% to 15%", user: "HMRC/CDS" },
  { timestamp: "2024-03-12 16:30:00", event: "Invoice Generated", reference: "INV-RM-2024-0848", detail: "Customer invoice raised for Northfield Electronics - €126.00 duties & taxes", user: "System (Auto)" },
  { timestamp: "2024-03-12 15:01:00", event: "Customs Submitted", reference: "BP-2024-00848", detail: "Electronic customs declaration submitted to HMRC via CDS", user: "System (Auto)" },
  { timestamp: "2024-03-12 14:24:12", event: "Shipment Created", reference: "ORD-2024-3892", detail: "Shipment RM-2024-00848 manifested with DDP terms for Northfield Electronics", user: "James Mitchell (Ops)" },
...
const invoiceDocuments = [
  { name: "RM Invoice to Northfield Electronics - March 2024", type: "Customer Invoice", format: "PDF", direction: "Outbound" },
  { name: "HMRC Duty Assessment - CE-UK-2024-12848", type: "HMRC Assessment", format: "PDF", direction: "Inbound" },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-5 gap-4">
        {[
          ...
          { label: "RM Net Position", value: "+€12,480", icon: Scale, sub: "Collected vs paid to HMRC" },
        ].map((kpi) => {
          const Icon = kpi.icon;
          return (
        ...
        >
          {reconciliationRecords.map((r, idx) => (
            <FedExTableRow key={r.id} even={idx % 2 === 1}>
              ...
              <FedExTableCell className="text-sm font-medium">{r.rmCharged}</FedExTableCell>
      ...
      {/* Charge Breakdown - RM Perspective */}
      <FedExSection title="Charge Breakdown - RM Charged vs HMRC Actual" icon={<Layers className="h-5 w-5 text-bp-red" />}>
        ...
        <FedExTable
          headers={[
            ...
            { label: "RM Charged Duty" },
            { label: "HMRC Actual Duty" },
            { label: "RM Charged VAT" },
            { label: "HMRC Actual VAT" },
          ]}
        >
          {chargeBreakdown.items.map((item, idx) => (
            <FedExTableRow key={idx} even={idx % 2 === 1}>
              ...
              <FedExTableCell>{item.rmChargedDuty}</FedExTableCell>
              <FedExTableCell className="font-bold">{item.hmrcActualDuty}</FedExTableCell>
              <FedExTableCell>{item.rmChargedVAT}</FedExTableCell>
        ...
        <div className="mt-4 bg-bp-light rounded-lg p-4">
          ...
          <div className="grid grid-cols-6 gap-4 text-center">
            <div><p className="text-xs text-bp-gray">RM Total Charged</p><p className="font-bold">{chargeBreakdown.parcelLevel.rmTotalCharged}</p></div>
            <div><p className="text-xs text-bp-gray">HMRC Actual</p><p className="font-bold">{chargeBreakdown.parcelLevel.hmrcTotalActual}</p></div>
            ...
            <div><p className="text-xs text-bp-gray">RM Margin</p><p className="font-bold text-bp-green">{chargeBreakdown.parcelLevel.rmMargin}</p></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* Documents & Invoices - RM perspective */}
      ...
      <div className="bg-bp-red/5 border border-bp-red/20 rounded-lg p-5">
        ...
        <p className="text-sm text-muted-foreground mb-4">Every shipment maintains linked references across the entire customs lifecycle - from customer quote through HMRC settlement, enabling full traceability across all accounts.</p>
        <div className="flex items-center justify-center gap-2">
          {["Customer Account", "Quote ID", "Order ID", "Shipment ID", "Customs Entry", "HMRC Settlement", "RM Invoice"].map((ref, i) => (
